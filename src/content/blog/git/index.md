...
```bash
git config --global user.name "StevenLuo" // 配置全局用户名为StevenLuo
...
```bash
git clone https://github.com/StevenLuo/eleme-web-vue.git
or
git clone git@git.github.com:StevenLuo/eleme-web-vue.git
```
...
**适用场景**: 当前本地的git项目是clone自`https://github.com/StevenLuo/eleme-web-vue.git`, 同时这个项目又需要同步关联coding上的另一个远程仓库`https://git.coding.net/StevenLuo/eleme-web-vue.git`, 要求每次`push`代码同步`push`到两个远程仓库。

```bash{3-5}
git remote add origin https://github.com/StevenLuo/eleme-web-vue.git
git remote add coding https://git.coding.net/StevenLuo/eleme-web-vue.git
git remote add all https://github.com/StevenLuo/eleme-web-vue.git // 将all关联到github上的远程仓库
git remote set-url --add --push all https://github.com/StevenLuo/eleme-web-vue.git // 在all上追加push对应的远程仓库地址为github的地址
git remote set-url --add --push all https://git.coding.net/StevenLuo/eleme-web-vue.git // 在all上追加push对应的远程仓库地址为github的地址
...
git remote add upstream https://github.com/StevenLuo/eleme-web-vue.git // 创建远程仓库源upstream并关联到原始仓库
...
```bash{3}
git submodule add https://github.com/StevenLuo/cars-component.git // 添加子模块
git submodule update --init --recursive
 // 更新一个含有submodule的远程仓库，同时拉取其submodule --recursive为可选
git clone --recursive https://github.com/StevenLuo/cars-component.git // 克隆一个含有submodule的远程仓库，同时拉取其submodule
```
...
```bash
git clone git clone https://github.com/StevenLuo/eleme-web-vue.git // 默认拉取master分支
```
...
```bash
git remote add origin https://github.com/StevenLuo/eleme-web-vue.git // 将远程仓库关联到本地git仓库的origin上，远程仓库必须为空项目
